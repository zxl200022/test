...
f = open('C:\\Users\\t4060\\Desktop\\syllabus.txt', 'r', errors='ignore')
raw = f.read()
...
flag = True
print("IDB: Ask me any questions about discussion board or syllabus")
while (flag == True):
    user_response = input()
    ...
    if (user_response != 'bye!!'):
        if (user_response == 'thanks' or user_response == 'thank you'):
            ...
            if (greeting(user_response) != None):
                print("IDB: " + greeting(user_response))
            else:
                print("IDB: ", end="")
